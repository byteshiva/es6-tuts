...
const {phoneToDial,oneSec,threeSec,twoMin,oneMin,siteForDial,countryName,phoneDialerSelector,dialpadAreaSelector,phoneElemSelector,areaCodeSelector,phoneNumSelector,btnCallSelector,beforeDialCallScrnShotPath,afterDialCallScrnShotPath} = conf;
